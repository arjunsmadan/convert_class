...
now = datetime(2026, 4, 2) #Prices as of close on this date
...
CORZ_31_now = ConvertibleBond(initial_stock_price = 15.78, current_stock_price = 16.23, conversion_premium = 42.5, coupon = 0.0, maturity = 7, time_to_maturity = CORZ_31_remaining_trading_years, risk_free_rate = 3.95, credit_spread = 320, costofborrow = 50, equity_vol = 70, div_yield = 0)
CORZ_29_now = ConvertibleBond(initial_stock_price = 8.46, current_stock_price = 16.23, conversion_premium = 30.0, coupon = 3.0, maturity = 5, time_to_maturity = CORZ_29_remaining_trading_years, risk_free_rate = 3.82, credit_spread = 280, costofborrow = 50, equity_vol = 60, div_yield = 0)

print(f"CORZ 2031 0s up 42.5: \n At issue, BS: {CORZ_31_issue.BS_total_value()}, binom: {CORZ_31_issue.binomial_convert_value(steps = 1000, credit_decay = 0.2)} \n Current - {formatted_now}, BS: {CORZ_31_now.BS_total_value()}, binom: {CORZ_31_now.binomial_convert_value(steps = 10000, credit_decay = 0.4)} \n Greeks: {CORZ_31_now.BS_greeks()}")
print(f"CORZ 2029 3s up 30.0: \n Current - {formatted_now}, BS: {CORZ_29_now.BS_total_value()}, binom: {CORZ_29_now.binomial_convert_value(steps = 10000, credit_decay = 0.2)} \n Greeks: {CORZ_29_now.BS_greeks()}")
